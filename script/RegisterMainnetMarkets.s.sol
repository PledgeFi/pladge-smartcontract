...
contract RegisterMainnetMarkets is Script {
    ...
    function run() external {
        ...
        address vaultAddr = vm.envAddress("MAINNET_VAULT_MANAGER");
        address oracleAddr = vm.envOr("MAINNET_ORACLE", address(0x195287cbcd53eF058a3DeC4c6DC8f17Bf79A28d9));
        ...
        console2.log("Register limit:", limit);
        ...
        for (uint256 i = 0; i < markets.length; i++) {
            ...
            (address existing,,,,,,,) = vault.markets(m.token);
            if (existing != address(0)) {
                console2.log("skip already registered", m.symbol);
                continue;
            }
        ...
        vm.stopBroadcast();
        console2.log("Registered this run:", registered);
    }
    ...
    function _markets() internal view returns (MarketConfig[] memory) {
        ...
        markets[3] = MarketConfig({
            ...
            feed: _feed("CHAINLINK_QQQ_FEED", 0x80901d846d5D7B030F26B480776EE3b29374C2ae),
            maxLtvBps: 7000,
            liqRatioBps: 14300
        });
        markets[4] = MarketConfig({
            ...
            feed: _feed("CHAINLINK_MSFT_FEED", 0x45C3C877C15E6BA2EBB19eA114Ea508d14C1Af2E),
            maxLtvBps: 6500,
            liqRatioBps: 15300
        });
        ...
        markets[6] = MarketConfig({
            ...
            feed: _feed("CHAINLINK_META_FEED", 0x7C38C00C30BEe9378381E7B6135d7283356D71b1),
            maxLtvBps: 6200,
            liqRatioBps: 16100
        });
        markets[7] = MarketConfig({
            ...
            feed: _feed("CHAINLINK_GOOGL_FEED", 0xF6f373a037c30F0e5010d854385cA89185AE638b),
            maxLtvBps: 6000,
            liqRatioBps: 16600
        });
